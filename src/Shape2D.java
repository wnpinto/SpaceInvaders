...
abstract public class Shape2D implements BoundingBox {
	...
	// public void moveTo(double x, double y) OUTDATED, just updateBoundingBox
	// {
	// xPos = x;
	// yPos = y;
	...
	public void updateBoundingBox(double xPos, double yPos) {
		// boundingBox.setLocation((int)(xPos - getBoundingBoxWidth()/2),(int)
		// (yPos - getBoundingBoxHeight()/2));
